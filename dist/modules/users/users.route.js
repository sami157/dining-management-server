...
router.put('/role/:userId', verifyFirebaseToken(authorization_1.ROLE_POLICIES.userRoleManagement), validateRequest({ params: users_validation_1.userIdParamsSchema, body: users_validation_1.updateUserRoleBodySchema }), users_controller_1.updateUserRole);
router.put('/fixedDeposit/:userId', verifyFirebaseToken(authorization_1.ROLE_POLICIES.memberFinanceManagement), validateRequest({ params: users_validation_1.userIdParamsSchema, body: users_validation_1.updateFixedDepositBodySchema }), users_controller_1.updateFixedDeposit);
router.put('/mosqueFee/:userId', verifyFirebaseToken(authorization_1.ROLE_POLICIES.memberFinanceManagement), validateRequest({ params: users_validation_1.userIdParamsSchema, body: users_validation_1.updateMosqueFeeBodySchema }), users_controller_1.updateMosqueFee);
